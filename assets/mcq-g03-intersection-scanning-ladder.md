# MCQ Bank: G3 Intersection Scanning Ladder

Units: 7-9
Use: End-of-group checkpoint after residential traffic checks, residential right-of-way, and major-street traffic checks.

Pass target: 80% or better. Review every miss by error category.

## Q1. Blocked two-way stop
...
## Q2. Uncontrolled residential intersection
...
## Q5. Pedestrian at an all-way stop
...
## Q6. Second viewing position

You are approaching a residential intersection with a stop sign. A van parked close to the corner blocks your view to the right. What is the best technique?

A. Stop at the line, then enter if you cannot hear traffic
B. Stop, scan left-center-right, move forward slowly to a better viewing point, and rescan
C. Pull out quickly so your vehicle becomes visible
D. Focus only on the direction you plan to turn
...
**Error category:** Blind intersection / inching

## Q7. Far edge hidden by SUV
...
## Q8. Left turn at a four-way stop
...
## Q9. Hidden right-side traffic

You are preparing to enter a busy major street from a residential side street. Traffic from the left is clear, but traffic from the right is hidden by a curve and parked vehicles. What is the safest decision?

A. Go because the first direction you checked is clear
B. Wait or inch forward only enough to improve your view, then complete another left-right-left scan
C. Turn on your signal and expect traffic to make space
D. Look straight ahead and listen for engines
...
**Error category:** Incomplete scan / cross traffic

## Q10. Green light on a major street
