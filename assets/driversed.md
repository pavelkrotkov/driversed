# Drivers Ed Video Transcripts

This file contains the full word-for-word transcripts WITH TIMINGS for all YouTube videos used in the Teen Hazard Perception Lab.

## Road Hazards in Residential Neighborhoods
- **YouTube ID:** `YUTAimvbfSk`
- **Source:** https://www.driverseddirect.com/videos/hazards/residential/default.aspx
...
## Commentary Driving (Rick)
- **YouTube ID:** `91fc2N1-5sw`
- **Source:** https://www.youtube.com/watch?v=91fc2N1-5sw

[00:00] ...test while they're waiting to try and find a driving instructor to help them out. So what I'm going to do is I'm just going to move off from the curb here out into the road.
...
## Traffic Checks - Part 1 (Residential)
- **YouTube ID:** `SbOWPZAbpvw`
- **Source:** https://www.driverseddirect.com/videos/traffic-checks-residential/

[0:00] Today we're looking at Traffic Checks and the role they play at any intersection you'll find in a neighborhood.
...
## How to Observe to Pass Your Road Test (Rick)
- **YouTube ID:** `TrtgVbd87SY`
- **Source:** https://www.youtube.com/watch?v=TrtgVbd87SY

[00:00] Hi there, smart drivers. Rick with Smart Drive Test, talking to you today about observation for the purposes of a road test. Observation is one of the four cornerstones of any road test, regardless of where you are in the world.
...
## Lane Positioning & Spatial Awareness
- **YouTube ID:** `0QlcsqV0JQY`
- **Source:** https://www.driverseddirect.com/videos/lane-positioning/residential/

[0:00] Having trouble avoiding parked cars? Following other vehicles too closely? Not sure where to drive on residential streets with no lane lines?
...
## Navigating Residential Curves
- **YouTube ID:** `LQZiG2OXkx8`
- **Source:** https://www.driverseddirect.com/videos/curves/residential/

[0:00] Hello current and future drivers of the world, it's Alejandra with Drivers Ed Direct. I will do my best to teach you all you need to know about navigating curved roads in residential neighborhoods.
...
## Residential Right-of-Way Rules
- **YouTube ID:** `xgXkH4l4eQA`
- **Source:** https://www.driverseddirect.com/videos/Right-of-Way/Residential/

[0:00] Hi, it's Micah with Drivers Ed Direct. Right-of-way determines 'whose turn it is' to use the road. CVC 525 defines it as 'the privilege of the immediate use of the highway.'
...
## Traffic Checks - Part 2 (Major Streets)
- **YouTube ID:** `OP-qM-ZrVPQ`
- **Source:** https://www.driverseddirect.com/videos/traffic-checks-major-streets/

[0:00] All right! Let's start with the review. A traffic check is a quick turn of the head, left, right, left, before we go through any type of intersection. It helps to determine right of way.
...
## Scanning And Moving Through Intersections (Rick)
- **YouTube ID:** `v0Soc-kicOQ`
- **Source:** https://www.youtube.com/watch?v=v0Soc-kicOQ

[00:00] When it's feeding, you simply need to be calm and relaxed. That way you can interpret traffic patterns and predict the individual actions of other road users. Let's go for a drive and I'll show you how to scan and track intersections correctly.
...
## Major Street Right-of-Way Rules
- **YouTube ID:** `2CXnQmudiD0`
- **Source:** https://www.driverseddirect.com/videos/Right-of-Way/Major-Streets/

[0:00] Introduction: Welcome to Right of Way Part Two. In Part 1, we looked at neighborhood streets; now we are looking at major streets.
...
## Right Turn on Red Anxiety Buster
- **YouTube ID:** `t7j8MEsS9Mc`
- **Source:** https://www.driverseddirect.com/videos/turns/right/right-turn-on-red/

[00:00] Hey, everybody! It's Ben with Drivers Ed Direct. Welcome to today's video on the 'Right Turn on Red Anxiety Buster.' Making a right turn on a red light in California is a must-have driving skill, but even though it seems simple, it's one of the most common reasons people fail their DMV Driving Test.
...
## Blind Spot Checks
- **YouTube ID:** `ZkVBf-LIGro`
- **Source:** https://www.driverseddirect.com/videos/blind-spots/

[0:00] Hi! My name is Micah with Drivers Ed Direct and in this video today we are talking about Blind Spot Checks.
...
- **YouTube ID:** `VFRv3Je7phs`
- **Source:** https://www.driverseddirect.com/videos/rearview-mirrors/part-2-using/

[0:00] Welcome back! Today we are going to talk about HOW and WHEN to use your rearview mirrors! Remember, do not stare, but instead take quick glances.
...
## Left Lane Change Anxiety Buster
- **YouTube ID:** `6TgFxB32fnE`
- **Source:** https://www.driverseddirect.com/videos/lane-changes/left/anxiety-buster/

[00:00] All right y'all, let's practice a nice easy left lane change. Remember, whenever we do a lane change, we want to remember the acronym SMOG: Signal, Mirror, Over the shoulder, then Go.
...
## Freeway Lane Changes & Defensive Driving
- **YouTube ID:** `eLWOkdwkhps`
- **Source:** https://www.driverseddirect.com/videos/lane-changes/freeway/

[00:00] Let's do it. Refresher: traffic on the freeway already has the right of way, so it's up to us to make the merge happen.
...
## Right-of-Way Part 3: Freeways and Canyons
- **YouTube ID:** `oizQKbE-OLs`
- **Source:** https://www.youtube.com/watch?v=oizQKbE-OLs

[0:00] Introduction: You made it to Right-of-Way Part 3. Today we're looking at the right-of-way rules we need to follow on freeways and canyons.
...
## Staying Safe Near Big Trucks
- **YouTube ID:** `Cw32CWOVL7c`
- **Source:** https://www.youtube.com/watch?v=Cw32CWOVL7c

[0:00] Introduction: How to stay safe when driving near big trucks.
...
## Smart Night Driving
- **YouTube ID:** `MpRHhikARbQ`
- **Source:** https://www.youtube.com/watch?v=MpRHhikARbQ

[00:00] As you're driving, because our eyes are attracted to light and movement, so in the darkness, you are looking for movement.
...
## DVSA: How the Hazard Perception Test Works
- **YouTube ID:** `SdQRkmdhwJs`
- **Source:** https://www.youtube.com/watch?v=SdQRkmdhwJs

[0:00] Introduction to the official DVSA Hazard Perception Test format.
