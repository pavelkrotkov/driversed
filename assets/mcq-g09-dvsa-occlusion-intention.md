# MCQ Bank: G9 DVSA Focused Practice: Occlusion + Intention

Units: 29-30
Use: End-of-group checkpoint after DVSA occlusion and intention sessions.

Pass target: 80% or better. Review every miss by error category.

## Q1. Pedestrian near a gap
...
## Q2. Bus at a crosswalk

A bus has stopped near a crosswalk. You cannot see the far side of the crosswalk or the sidewalk beyond the bus. What should you expect?

A. The bus blocks pedestrians from crossing, so the path is clear
B. A pedestrian may appear from in front of or behind the bus
C. The only hazard is whether the bus starts moving again
D. You should move left quickly to pass before traffic builds up
...
**Error category:** Large-vehicle blocked sightline
...
You are approaching the crest of a hill. You can see the road surface near you, but not the traffic, pedestrians, or side roads beyond the crest. What is the safest interpretation?

A. The road is clear because the visible section is clear
B. The crest is a blocked sightline, so reduce risk before the hidden area opens
C. Accelerate slightly to spend less time where visibility is poor
D. Move right to improve your view over the hill

**Answer:** B
**Explanation:** A crest hides what is beyond it. Speed should match the distance you can see and react to.
**Error category:** Crest occlusion

## Q5. Wheel angle without signal
...
## Q6. Braking and body language

A vehicle ahead is approaching a driveway. Its brake lights come on, it drifts slightly toward the curb, and the driver turns their head toward the driveway. What should you expect?

A. The vehicle may turn or stop, even if no turn signal is showing
B. The vehicle is only adjusting lane position and will continue normally
C. The driver is checking mirrors, so you can maintain speed
D. The vehicle cannot turn unless it first signals for several seconds
...
**Error category:** Body-language and braking cue
