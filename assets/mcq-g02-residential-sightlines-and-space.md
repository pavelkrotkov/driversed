# MCQ Bank: G2 Residential Sightlines and Space

Units: 3-6
Use: End-of-group checkpoint after potential vs developing hazards, residential hazards, lane position, space management, and residential curves.

Pass target: 80% or better. Review every miss by error category.

## Q1. Potential or developing?
...
A new driver keeps looking at the pavement directly in front of the hood and makes small steering corrections every few seconds. What should they do instead?

A. Aim high, look 10 to 15 seconds ahead, and scan the big picture
B. Look only at the parked cars on the right
C. Watch the center mirror continuously
D. Grip the wheel tighter and steer more often

**Answer:** A
**Explanation:** Looking 10 to 15 seconds ahead improves lane position and reveals potential hazards earlier.
**Error category:** Visual lead time

## Q8. Curve as occlusion

You approach a sharp residential curve with parked cars near the outside of the bend. You cannot see what is around the curve. What is the safest interpretation?

A. The curve is only a steering task
B. The curve is an occlusion that may hide a pedestrian, vehicle, bike, or parked car
C. The curve is safe if there is no yellow centerline
D. The curve matters only if the road is wet

**Answer:** B
**Explanation:** A curve is a blocked sightline. The important hazard may be beyond what you can see.
**Error category:** Curve occlusion

## Q9. Speed before a curve
...
## Q10. Cyclist near parked cars

You are on a narrow residential street. A cyclist is ahead near parked cars, and an oncoming car is approaching. What is the best decision?

A. Squeeze between the cyclist and oncoming car because you have space
B. Hold back, keep following distance, and pass only when you can leave safe side clearance
C. Honk so the cyclist moves closer to the parked cars
D. Pass close to the cyclist but stay far from the oncoming car
