...
const dvsaCourse = "https://www.safedrivingforlife.info/shop/official-dvsa-guide-hazard-perception-elearning/";
...
window.HPT_CURRICULUM = {
  ...
  modules: [
    ...
    {
      id: 3,
      slug: "03-ded-residential-hazards",
      file: "03-ded-residential-hazards.html",
    ...
    {
      id: 4,
      slug: "04-ded-residential-traffic-checks",
      file: "04-ded-residential-traffic-checks.html",
    ...
    {
      id: 7,
      slug: "07-ded-residential-right-of-way",
      file: "07-ded-residential-right-of-way.html",
    ...
    {
      id: 8,
      slug: "08-ded-major-street-traffic-checks",
      file: "08-ded-major-street-traffic-checks.html",
    ...
    {
      id: 9,
      slug: "09-ded-major-street-right-of-way",
      file: "09-ded-major-street-right-of-way.html",
    ...
    {
      id: 10,
      slug: "10-ded-right-turn-on-red",
      file: "10-ded-right-turn-on-red.html",
    ...
    {
      id: 11,
      slug: "11-ded-blind-spot-checks",
      file: "11-ded-blind-spot-checks.html",
      ...
      time: "10-15 min",
      video: "ZkVBf-LIGro",
      preWatch: "Blind spots are just occlusion beside the car. Watch this clip as a visibility lesson: mirrors give information, but they do not prove the space is empty.",
      sourceFit: "DED gives the student a direct blind-spot demonstration before the course moves into mirrors and lane changes.",
    ...
    },
    {
      ...
      time: "10-15 min",
      video: "VFRv3Je7phs",
      preWatch: "Hazard perception is not only forward. The car behind you changes your escape options, braking margin, and lane-change choices. Watch for how mirror checks keep the whole traffic picture alive.",
    ...
    {
      id: 13,
      slug: "13-ded-left-lane-change",
      file: "13-ded-left-lane-change.html",
    ...
    {
      id: 14,
      slug: "14-ded-freeway-lane-change",
      file: "14-ded-freeway-lane-change.html",
    ...
    {
      id: 15,
      slug: "15-potential-vs-developing-hazard",
      file: "15-potential-vs-developing-hazard.html",
      ...
      preWatch: "Before simulator scoring, learn the timing language. A potential hazard is something that could matter. A developing hazard has started to change your plan. The point is not to react to everything; it is to notice when a possible risk becomes an action-now risk.",
      sourceFit: "The UK terminology is useful even for a U.S. teen because it separates early awareness from actual developing-hazard timing.",
    ...
    },
    {
      ...
      logPrompts: ["Mock score or readiness indicator.", "Top two error types.", "One specific next practice target."],
      resources: [source("Official DVSA e-learning", dvsaCourse)]
    }
  ]
};
